 ...
 * "color" color. Color is optional and can be any of the following: "player0",
 * "player1", "player2" or "player3".  Default is player0.
 * 
...
public class DebugConsole : MonoBehaviour
{
	...
	public Vector3 defaultGuiPosition = new Vector3 (.02f, .93f, -5f);//new Vector3(0.01F, 0.98F, 0F);
	public Vector3 defaultGuiScale = new Vector3(0.5F, 0.5F, 1F);
	public Color player0 = Color.red;
	public Color player1 = Color.yellow;
	public Color player2 = Color.green;
	public Color player3 = Color.blue;
	public Color system = Color.white;
	...
	public bool draggable = false;                  // Can the output be dragged around at runtime by default? 
	...
	public static void SetOriginalScreenSize(){
	...
	public void InitGuis()
	{
		...
		if (guisCreated == false)
		{
			...
			Vector3 size = DebugGui.transform.localScale;
			Vector2 screenSizeDiff = new Vector2(lastScreenSize.x/Screen.width, lastScreenSize.y/Screen.height);
			lastScreenSize = new Vector2(Screen.width, Screen.height);
			for(int x=0;x < guis.Count; x++)
			{
				size.x = size.x*screenSizeDiff.x;
				size.y = size.y*screenSizeDiff.y;
				GameObject temp = (GameObject)guis[x];
		...
		else if (visible == true)
		{
			...
			else
			{
				while (x < messages.Count)
				{
					...
					{
					case "player0": gui.guiText.material.color = player0;
						break;
					case "player1": gui.guiText.material.color = player1;
						break;
					case "player2": gui.guiText.material.color = player2;
						break;
					case "player3":  gui.guiText.material.color = player3;
						break;
					case "system": gui.guiText.material.color = system;
						break;
					default:
						break;
					}
